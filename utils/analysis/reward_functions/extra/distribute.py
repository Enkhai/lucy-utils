...
def distribute(rewards, team_idcs, team_spirit=0.3):
    ...
    blue_means = rewards[~team_idcs].mean(1)
    orange_means = rewards[team_idcs].mean(1)

    blue = blue_means[~team_idcs] * team_spirit + rewards[~team_idcs] * (1 - team_spirit) - orange_means[team_idcs]
    orange = orange_means[team_idcs] * team_spirit + rewards[team_idcs] * (1 - team_spirit) - blue_means[~team_idcs]
